...
#
# Retrieved from SimpleITK/TUTORIAL
...
def append_values(registration_method):
    global metric_values
    #print("append value:" + str(registration_method.GetMetricValue()))
